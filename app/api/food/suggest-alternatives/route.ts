...
Propose 4 aliments DIFFÉRENTS (pas des variantes du même aliment) qui peuvent le remplacer dans un repas,
...
Retourne un objet JSON avec un champ "suggestions" : 4 objets avec ces champs OBLIGATOIRES (valeurs pour 100g) :
