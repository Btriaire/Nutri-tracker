...
export default async function DesktopLogPage() {
  ...
  return <LogClientDesktop date={today} initialLog={dayLog} goals={goals} lang={lang} trackedNutrients={trackedNutrients} />;
}
